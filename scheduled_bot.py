...
import random
import  schedule
import time # для логов


RECIEVER_USER_ID = "221132552"


class Scheduled_bot(Bot):
    """Бот, отправляющий сообщения по расписанию.
        Наследуется от класса Bot"""

    # прозвища, учавствующие в генерации фраз
    pet_names = [
        "котёнок",
        "зайчонок",
        "солнышко",
    ...
    def wish_good_morning(self):
        ...
        Сообщение будет отправлено пользователю с default_user_id (можно изменить опционно при вызове функции)
        """
        ...
        self.send_message(receiver_user_id=RECIEVER_USER_ID, message_text=message)
    ...
    def talk_about_lunch(self):
        ...
        phrases = [
            ...
            "Что ты ела сегодня, {}?".format(pet_name),
        ]
        message = phrases[random.randint(0, len(phrases) - 1)]
        self.send_message(receiver_user_id=RECIEVER_USER_ID, message_text=message)
    ...
    def create_schedule(self):
        ...
        # отправка сообщения с утра в случайный момент
